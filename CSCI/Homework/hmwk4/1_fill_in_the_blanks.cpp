...
void comparePerimeters(int perimeter_1, int perimeter_2, int width_1, int width_2);
...
void comparePerimeters(int width_1, int width_2, int height_1, int height_2)
{
    int perimeter_1 = calculatePerimeter(width_1, height_1);
    int perimeter_2 = calculatePerimeter(width_2, height_2);
